        ...
        <section className="relative bg-white overflow-hidden py-0">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-10">
                    ...
                    {/* LEFT — Content */}
                    <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-center py-10 md:py-20">

                        {/* Eyebrow */}
                        <p className="text-[#00a63e] text-xs font-black uppercase tracking-[0.2em] mb-4 text-center md:text-left">
                            Available on iOS & Android
                        </p>

                        {/* Heading */}
                        <h2 className="text-3xl md:text-4xl font-bold text-[#1B2A4A] leading-tight mb-5 text-center md:text-left">
                            Download the{' '}
                        ...
                        {/* QR + Store Buttons */}
                        <p className="text-[#1B2A4A] text-sm font-semibold mb-4 opacity-70 text-center md:text-left">
                            Scan this QR code to download the app
                        </p>

                        <div className="flex items-center gap-6">
                            {/* QR Code — hidden on mobile */}
                            <div className="hidden sm:flex w-24 h-24 border-2 border-[#1B2A4A]/10 rounded-xl overflow-hidden flex-shrink-0 bg-white p-1.5 shadow-md">
                    ...
                    {/* RIGHT — Phone Mockup */}
                    <div className="w-full md:w-1/2 flex items-center justify-center md:justify-end py-6 md:py-10">
                        {/* Scale down phone on mobile/tablet */}
