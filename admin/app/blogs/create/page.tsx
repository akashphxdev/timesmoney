...
export default function CreateBlogPage() {
  ...
  useEffect(() => {
    ...
    api.get('/sub-categories').then((res) => setSubCategories(res.data.data)).catch(() => {});
  }, []);
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      {/* ✅ items-start — right sidebar page ke saath scroll hoga, sticky nahi */}
      <div className="grid grid-cols-3 gap-6 items-start">
        ...
        <div className="col-span-2 space-y-4">
          ...
          <div className={`bg-white rounded-2xl border p-6 ${fieldErrors.content ? 'border-red-400' : 'border-gray-200'}`}>
            ...
            <Editor content={content} onChange={(val) => {
              setContent(val);
        ...
        {/* Right Sidebar — NO sticky, scrolls with page */}
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-5 space-y-3">
            ...
            <label className={`w-full flex items-center justify-center px-4 py-2.5 text-sm text-gray-500 border border-dashed rounded-xl cursor-pointer hover:bg-gray-100 ${
              fieldErrors.coverImage ? 'border-red-400 bg-red-50' : 'bg-gray-50 border-gray-300'
            }`}>
