...
exports.validateUpdateAd = exports.validateCreateAd = void 0;
const validPages = [
...
const validateCreateAd = (body) => {
    ...
    if (pages.length === 0)
        ...
        if (invalidPages.length > 0)
            errors.push(`Invalid pages: ${invalidPages.join(', ')}`);
    }
...
exports.validateCreateAd = validateCreateAd;
const validateUpdateAd = (body) => {
    const errors = [];
...
exports.validateUpdateAd = validateUpdateAd;
