...
// // import { getHomeData, createHeroLead } from '../../services/public/home.service';
...
// //     const { name, phone, categoryId, subCategoryId } = req.body;

// //     const lead = await createHeroLead({ name, phone, categoryId, subCategoryId });
